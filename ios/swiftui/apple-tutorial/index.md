...
The List initializer in this step accepts a **ViewBuilder** as its only
...
Navigation modifiers, such as title and bar items, are added to child views and
...
그.. 여기 방식이 좋은건가? edit이랑 상관없는 뷰에 순전히 edit을 위한 변수가 있는
